...
run_tests() {
    ...
    test_failure "Missing listen directive" "$TEST_DIR/23_no_listen.conf" "listen is required"
    ...
    test_failure "Empty server block" "$TEST_DIR/55_empty_server.conf" "listen is required"
